...
export type RuleWhereInput = {
  ...
  category?: Prisma.StringFilter<"Rule"> | string
...
export type RuleScalarWhereWithAggregatesInput = {
  ...
  category?: Prisma.StringWithAggregatesFilter<"Rule"> | string
...
export type RuleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "category" | "content" | "updatedAt" | "createdAt", ExtArgs["result"]["rule"]>
...
export interface RuleFieldRefs {
  ...
  readonly category: Prisma.FieldRef<"Rule", 'String'>
